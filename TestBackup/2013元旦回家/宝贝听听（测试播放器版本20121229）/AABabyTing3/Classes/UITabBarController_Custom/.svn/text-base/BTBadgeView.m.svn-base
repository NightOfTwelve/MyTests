...
@synthesize width, badgeString, parent, badgeColor, badgeColorHighlighted, shadowEnabled,delegate, fontSize;
// from private
@synthesize font;
...
//扩展 by Zero
- (id) initWithFrame:(CGRect)frame fontSize:(NSInteger)aFontSize
{
	if (self = [super initWithFrame:frame])
	{
		self.fontSize = aFontSize;
		font = [[UIFont boldSystemFontOfSize: aFontSize] retain];
...
{	
	...
	bounds.origin.y++;
	if (self.fontSize == 10) {//更多标签上的“新版本”
		bounds.origin.y += 3;
	}
