...
#define kAQWriteSize      (kAQDefaultBufSize * 1)
typedef enum
{
	AS_INITIALIZED = 0,
...
@interface AudioStreamer : NSObject<NSStreamDelegate>
{
#if TARGET_OS_IPHONE    
    ...
    AudioStreamerStopReason             pauseReason;
    ...
    NSMutableData                       *_tempAudioData;
    int                                 _byteIndex;
    NSTimer                             *timer;
    BOOL                                interruptByPhone;
    BOOL                                isLowStory;
}
...
@property (readonly) AudioStreamerStopReason        pauseReason;
...
@property (assign) BOOL                             isLowStory;
@property (retain) NSMutableData                    *tempAudioData;
