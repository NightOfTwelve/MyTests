...
//	[self.view bringSubviewToFront:self.keyView];
...
//	[keyView addSubview:backgroundView];
	//网上教的，效果好使了，待研究……
	//http://stackoverflow.com/questions/4576847/how-to-overlay-view-over-navigation-controller-bar
...
//#pragma mark - 扩展
//
//- (void)setThePopoverVisible:(BOOL)b {
//	popoverVisible = b;
//	if ([self.contentViewController isKindOfClass:[BTHotStoryListController class]]) {
//		BTHotStoryListController *pcvc = (BTHotStoryListController *)self.contentViewController;
//		pcvc.arrowDirectionUp = b;
//	}
//}
