...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (NSError*)request:(BTTingImageRequest*)request processResponse:(NSHTTPURLResponse*)response
               data:(id)data {
    ...
    if ([data isKindOfClass:[UIImage class]]) {
        ...
        if (nil != image) {
            if (!request.respondedFromCache) {
                ...
                //        }
                [[TTURLCache sharedCache] storeImage:image forURL:[BTThree20Constant stringByURL:request.urlPath suffix:request.suffix]];
            }
